...
return (
  <div className="space-y-4">
    <div className="text-center pb-4 border-b">
      <p className="text-sm animated-gradient mb-2">Your Balance</p>
      <p
    ...
    {isAllSettledUp ? (
      ...
      <div className="space-y-4">
        ...
        {owedByMembers.length > 0 && (
          <div>
            ...
            <div className="space-y-3">
              {owedByMembers.map((member) => (
                <div
                  key={member.id}
                  className="flex items-center justify-between border-1 p-2 rounded-md gradient-title text-green-600 italic"
                >
         ...
         {owingToMembers.length > 0 && (
            <div>
              <h3 className="text-sm font-medium flex items-center mb-3 text-red-500  ">
              ...
              <div className="space-y-3 ">
                {owingToMembers.map((member) => (
                  ...
                  >
                    <div className="flex items-center gap-2 ">
                      <Avatar className="h-8 w-8">
                        <AvatarImage src={member.imageUrl}  className=''/>
                        <AvatarFallback>
                          {member.name?.charAt(0) ?? "?"}
                        </AvatarFallback>
                      </Avatar>
