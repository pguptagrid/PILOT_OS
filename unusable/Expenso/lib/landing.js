...
export const TESTIMONIALS = [
  {
    quote:
      "La de re baba de ... la mere 5 crore de!",
    name: "Babu Rao",
    image: "/testimonials/babubhaiya.png",
    role: "Bhada lene Wala! ",
    emozi:"😂"
  },
  {
    quote:
      "Paisa hath me aaya nhi or bhikhriyo ki tarah bhik mangna shuru.",
    name: "Raju",
    image: "/testimonials/raju.jpg",
    role: "24 Gante me paisa double krne wala!",
    emozi:'😎'
  },
  {
    quote:
      "Golmal hai bhai sab golmal hai. Me bta rha hu nhi dega ye paise. Kangal kar dega hume ye.",
    name: "Shyam",
    image: "/testimonials/shyam.png",
    role: "Paiso ke mamle me risk nhi lene wala!",
    emozi:'🤯'
  },
];