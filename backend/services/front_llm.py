...
_KEYWORDS = [
    ...
    (
        ...
        {
            "action": "respond_now",
            "preamble": "Hey! I'm listening — what can I help with?",
            "tool": None,
            "args": {},
            "mode": "queue",
        },
    ...
    (
        ...
        {
            "action": "respond_now",
            "preamble": "Happy to help! What else can I do?",
            "tool": None,
            "args": {},
            "mode": "queue",
        },
    ...
    (
        ...
        {
            "action": "delegate",
            "preamble": "Looking up that customer.",
            "tool": "crm_lookup",
            "args": {},
            "mode": "queue",
        },
    ...
    (
        ...
        {
            "action": "delegate",
            "preamble": "Querying the database for you.",
            "tool": "database_query",
            "args": {},
            "mode": "queue",
        },
    ...
    (
        ...
        {
            "action": "delegate",
            "preamble": "On it! Writing that file and generating the code in the background. Please wait while I process the script.",
            "tool": "write_file",
            "args": {},
            "mode": "queue",
        },
    ...
    (
        ...
        {
            "action": "delegate",
            "preamble": "Running a system check now.",
            "tool": "system_check",
            "args": {},
            "mode": "queue",
        },
    ...
    (
        ...
        {
            "action": "delegate",
            "preamble": "Starting that complex calculation now.",
    ...
    (
        ...
        {
            "action": "delegate",
            "preamble": "Canceling active process immediately.",
            "tool": "cancel_task",
            "args": {},
            "mode": "interrupt",
        },
...
class FrontLLMProvider:
    ...
    async def classify(
        self, text: str, speaker_id: str, role: str, context: list, session_id: str = ""
    ) -> dict:
        ...
        if any(
            ...
            print(
                f"⚡ [FRONT LLM INTERCEPT] Clear presentation action: '{result['action']}' | Tool: '{result['tool']}'"
            )
            return result
        ...
        if any(
            ...
            for phrase in (
                ...
                "create slide about ",
                "add a slide explaining ",
                "add slide explaining ",
                "add slide ",
                "add a slide ",
                "insert slide ",
                "insert a slide ",
            ...
            if is_verified:
                ...
                result["preamble"] = "Hello there! " + result["preamble"]
            print(
                f"⚡ [FRONT LLM INTERCEPT] Add slide action: '{result['action']}' | Tool: '{result['tool']}' | Topic: '{topic}'"
            )
            return result
        ...
        if any(
            ...
            title = ""
            for phrase in (
                "change the title of this slide to ",
                "change the title to ",
                "change title of this slide to ",
                "change title to ",
                "update slide title to ",
                "update the title to ",
                "set the title of this slide to ",
                "set the title to ",
                "set slide title to ",
            ...
            if title:
                ...
                if is_verified:
                    ...
                    result["preamble"] = "Hello there! " + result["preamble"]
                print(
                    f"⚡ [FRONT LLM INTERCEPT] Edit slide title action: '{result['action']}' | Tool: '{result['tool']}' | Title: '{title}'"
                )
                return result
        ...
        if any(
            ...
            for phrase in (
                ...
                "add a bullet point explaining ",
                "add a bullet about ",
                "add a bullet explaining ",
                "add bullet point about ",
                "add bullet point explaining ",
                "add bullet about ",
                "add bullet explaining ",
                "add bullet point ",
                "add bullet ",
                "insert bullet ",
                "append bullet ",
            ...
            if bullet_text:
                ...
                if is_verified:
                    ...
                    result["preamble"] = "Hello there! " + result["preamble"]
                print(
                    f"⚡ [FRONT LLM INTERCEPT] Add slide bullet action: '{result['action']}' | Tool: '{result['tool']}' | Bullet: '{bullet_text}'"
                )
                return result
        ...
        if any(kw in user_clean for kw in ("summarize", "summarise", "summary")):
            if any(ref in user_clean for ref in ("ppt", "presentation", "slides", "powerpoint")):
                if not re.search(r"slide\s+\d+", user_clean) and not any(
                    f in user_clean for f in ("first slide", "last slide", "current slide", "this slide")
                ):
                    is_summarize = True
        ...
        if is_summarize:
            ...
            if is_verified:
                ...
                result["preamble"] = "Hello there! " + result["preamble"]
            print(
                f"⚡ [FRONT LLM INTERCEPT] Slide Summarize action: '{result['action']}' | Tool: '{result['tool']}'"
            )
            return result
        ...
        ) and ("slide" in user_clean or "presentation" in user_clean or "powerpoint" in user_clean):
            is_slide_qa = True
        ...
        if is_slide_qa:
            ...
            if is_verified:
                ...
                result["preamble"] = "Hello there! " + result["preamble"]
            print(
                f"⚡ [FRONT LLM INTERCEPT] Slide Q&A action: '{result['action']}' | Tool: '{result['tool']}'"
            )
            return result
        ...
        if any(
            ...
            if is_verified:
                ...
                result["preamble"] = "Hello there! " + result["preamble"]
            print(
                f"⚡ [FRONT LLM INTERCEPT] Slide creation action: '{result['action']}' | Tool: '{result['tool']}'"
            )
            return result
        ...
        if any(
            q in user_clean
            for q in ("delete slide", "remove slide", "delete this slide", "remove this slide")
        ):
            result = {
                "action": "delegate",
            ...
            if is_verified:
                ...
                result["preamble"] = "Hello there! " + result["preamble"]
            print(
                f"⚡ [FRONT LLM INTERCEPT] Slide delete action: '{result['action']}' | Tool: '{result['tool']}'"
            )
            return result
        ...
        if any(
            ...
            for q in (
                ...
                "rewrite this slide",
                "rewrite slide",
                "improvise this slide",
                "improvise slide",
            )
        ):
            prompt = ""
            for phrase in (
                "improve this slide by ",
                "improve slide by ",
                "make this slide ",
                "make slide ",
                "rewrite this slide by ",
                "rewrite slide by ",
                "improvise this slide by ",
                "improvise slide by ",
                "improve this slide ",
                "improve slide ",
                "rewrite this slide ",
            ...
            if is_verified:
                ...
                result["preamble"] = "Hello there! " + result["preamble"]
            print(
                f"⚡ [FRONT LLM INTERCEPT] Improvise slide action: '{result['action']}' | Tool: '{result['tool']}' | Prompt: '{prompt}'"
            )
            return result
        ...
        if user_clean in slide_commands:
            ...
            r"^(go\s+to\s+)?slide\s+(?:number\s+|no\s+|#\s*)?(\d+|one|two|three|four|five|six|seven|eight|nine|ten)$",
            user_clean,
        ):
            is_slide_cmd = True
        elif (
            user_clean.startswith("go to slide ")
            or user_clean.startswith("jump to slide ")
            or "slide number" in user_clean
        ):
            is_slide_cmd = True
        ...
        if is_slide_cmd:
            ...
            if is_verified:
                ...
                result["preamble"] = "Hello there! " + result["preamble"]
            print(
                f"⚡ [FRONT LLM INTERCEPT] Slide navigation action: '{result['action']}' | Tool: '{result['tool']}'"
            )
            return result
        ...
        if "email" in user_clean or "mail" in user_clean:
            ...
            if any(
                ...
                if not topic:
                    ...
                    _has_subject = _pre_subject and _pre_subject not in (
                        "Enter email subject",
                        "Update from PILOT Voice OS",
                        "",
                    )
                    if not _has_subject:
                        ...
                        print(
                            "⚡ [FRONT LLM INTERCEPT] Email command: no topic or subject — asking user for clarification"
                        )
                        return {
                            "action": "respond_now",
            ...
            if is_verified:
                ...
                result["preamble"] = "Hello there! " + result["preamble"]
            print(
                f"⚡ [FRONT LLM INTERCEPT] Email command delegated: '{result['tool']}' with topic: '{result['args'].get('query')}'"
            )
            return result
        ...
        if not is_kb_query and (
            "flight" in user_clean
            or "flights" in user_clean
            or "book" in user_clean
            or "travel" in user_clean
        ):
                        ...
                        if resp.status_code == 200:
                            ...
                            if is_verified:
                                ...
                                if result.get("preamble"):
                                    result["preamble"] = "Hello there! " + result["preamble"]
                            print(
                                f"✅ [FRONT LLM SUCCESS] Ollama ({active_model}) routed successfully! Action: '{result.get('action')}' | Preamble: \"{result.get('preamble')}\" | Tool: '{result.get('tool')}'"
                            )
                            return result
                except Exception as e:
                    print(
                        f"⚠️ [FRONT LLM WARNING] Ollama model '{active_model}' failed/not found: {e}. Trying next available fallback model."
                    )
        ...
        print(
            f"ℹ️ [FRONT LLM KEYWORDS] Keyword matching routed action: '{result.get('action')}' | Preamble: \"{result.get('preamble')}\""
        )
    ...
    def _keyword_fallback(self, text: str) -> dict:
        ...
        if any(kw in t for kw in ("summarize", "summarise", "summary")):
            if any(ref in t for ref in ("ppt", "presentation", "slides", "powerpoint")):
                if not re.search(r"slide\s+\d+", t) and not any(
                    f in t for f in ("first slide", "last slide", "current slide", "this slide")
                ):
                    is_summarize = True
        ...
        if ("slide" in t or "presentation" in t or "powerpoint" in t) and any(
            q in t
            for q in (
                "explain",
                "describe",
        ...
        if any(
            ...
            return {
                "action": "delegate",
                "preamble": "Cancelling ongoing background tasks!",
                "tool": "cancel_task",
                "args": {},
                "mode": "interrupt",
            }
